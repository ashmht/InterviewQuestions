...
public class Problem11 {
	...
	private static void computeMatrixProd() {
		// TODO Auto-generated method stub

		int max = 0;
		max = Math.max(max, findRowMax());
		max = Math.max(max, findColMax());
		max = Math.max(max, findDiagonalMax());
		max = Math.max(max, findReverseMax());
		System.out.println(max);

	}

	private static int findReverseMax() {
		// TODO Auto-generated method stub
		int prod = 0;
		int maxprod = 0;
		for (int i = 3; i < 20; ++i)
	...
	private static int findDiagonalMax() {
		// TODO Auto-generated method stub
		int prod = 0;
		int maxprod = 0;
		for (int i = 0; i < 16; ++i)
